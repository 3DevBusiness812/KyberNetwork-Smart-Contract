...
contract LinkTokenMock is ITypeAndVersion, LinkERC20, ERC677 {
    ...
    constructor(address to) ERC20(NAME, SYMBOL) {
        _onCreate(to);
    }
     ...
     */
    function _onCreate(address user) internal virtual {
        _mint(user, TOTAL_SUPPLY);
    }
